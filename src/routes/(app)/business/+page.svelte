...
>
	<Hero title={m.business_hero_title()} lead={m.business_hero_lead()} class="pt-12">
		{#snippet cta()}
			<div class="sm:grid-cols-auto grid grid-rows-2 gap-2 sm:flex sm:grid-rows-none">
				<Button size="lg" variant="default" href={localizeHref('/signup')}>
		...
		<div class="flex">
			<Dialog.Root>
				...
				<Dialog.Content class="">
					...
					<CreateSecret form={data.secretForm} hidePrimaryFeatureList />
				</Dialog.Content>
			</Dialog.Root>
		</div>
	</Section>
